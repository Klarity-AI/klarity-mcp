...
<Steps>
  <Step title="Pick your client">
    ...
    <Columns cols={2}>
      <Card title="Claude" icon="comment" href="/install/claude">Anthropic web client</Card>
      <Card title="Claude Code" icon="terminal" href="/install/claude-code">Anthropic CLI</Card>
      <Card title="ChatGPT" icon="comment-dots" href="/install/chatgpt">OpenAI web client</Card>
      <Card title="Codex" icon="code" href="/install/codex">OpenAI CLI</Card>
      <Card title="Cursor" icon="cursor" href="/install/cursor">IDE</Card>
      <Card title="Gemini CLI" icon="google" href="/install/gemini-cli">Google CLI</Card>
    </Columns>
  </Step>
