...
| [Observations & changes](/tools/observations-and-changes) | Recent changes, observations, activity timelines | "What changed?", "what happened?", "why does this run this way?" |
