...
See [Tools by purpose → Process Index](/tools/process-index) and [Process observations and changes](/tools/observations-and-changes) for the full toolset, and [Find opportunities](/guides/find-opportunities) for an end-to-end walkthrough.
