...
<Columns cols={2}>
  ...
  <Card title="Drive AI transformation" icon="compass" href="/transformation">
    Set an objective, build the Company Brain, and turn it into skills and agents.
  </Card>
...
Klarity organizes operational intelligence into two layers — **Process Index (aka Process Context Graph)** and **Artifacts** — and the MCP gives your assistant query access to both.
...
<Columns cols={2}>
  ...
  <Card title="Build agents and skills" icon="robot" href="/guides/agent-builder">
