---
title: "FAQ"
description: "Common questions and gotchas from people setting up and using the Within MCP."
...
<AccordionGroup>
  ...
  <Accordion title="My organization doesn't have Within yet. Can I use this?" icon="building">
  ...
  <Accordion title="How do I switch between Within workspaces?" icon="arrows-rotate">
